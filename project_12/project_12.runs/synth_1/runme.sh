...
HD_PWD='/home/rehan/project_12/project_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReV_SoC_top_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReV_SoC_top_FPGA.tcl
